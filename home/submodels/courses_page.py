...
class CoursesPage(Page):
    ...
    def _get_courses_paged(self, page, sort_args, difficulty_args, provider_args):
    ...
    def _get_difficulties(self, request):
        difficulties = [enum_val for enum_val, _ in CourseDetailPage.CourseDifficulty.choices]
    ...
    def _get_filter_buttons(args, choices):
        dropdown_btns = {str(choice): 'badge-white' for choice in choices}
        for selection in args:
            dropdown_btns[selection] = 'badge-primary'
        if args:
    ...
    def get_context(self, request):
        ...
        context['courses_paged'] = self._get_courses_paged(page, sort_args, difficulty_args, provider_args)
